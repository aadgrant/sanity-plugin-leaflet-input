...
var GeopointInput = /*#__PURE__*/_react.default.forwardRef(function GeopointInput(props, ref) {
  ...
  var center = value && value.lat && value.lng ? value : typeOptions.defaultLocation || _configLeafletInput.default.defaultLocation || DEFAULT_CENTER;
  ...
  var showFields = typeOptions.showFields || _configLeafletInput.default.showFields || SHOW_FIELDS;
  ...
  function setMarkerLocation(_ref3) {
    var lat = _ref3.lat,
        lng = _ref3.lng,
        alt = _ref3.alt;
    onChange(_patchEvent.PatchEvent.from([(0, _patchEvent.setIfMissing)({
      _type: type.name
    }), ...(lat ? [(0, _patchEvent.set)(parseFloat(lat), ['lat'])] : []), ...(lng ? [(0, _patchEvent.set)(parseFloat(lng), ['lng'])] : []), ...(alt ? [(0, _patchEvent.set)(parseFloat(alt), ['alt'])] : [])]));
  }
  ...
  return /*#__PURE__*/_react.default.createElement(_default3.default, {
    ...
    trackResize: true
  }, /*#__PURE__*/_react.default.createElement(_reactLeaflet.TileLayer, tileConfig), value && value.lat && value.lng && /*#__PURE__*/_react.default.createElement(_reactLeaflet.Marker, {
  ...
  }, "Remove point"))), /*#__PURE__*/_react.default.createElement(_reactLeaflet.ZoomControl, {
    position: "topright"
  })), /*#__PURE__*/_react.default.createElement("p", {
    className: _GeopointInput.default.helpText
  }, getHelpText(value))), showFields && /*#__PURE__*/_react.default.createElement("div", {
    className: _GeopointInput.default.inputFields
  }, /*#__PURE__*/_react.default.createElement("input", {
    name: "lat",
    className: _GeopointInput.default.inputField + ' ' + _GeopointInput.default.lat,
    type: "number",
    value: value && value.lat ? value.lat : '',
    onChange: evt => setMarkerLocation({
      lat: evt.target.value
    })
  }), /*#__PURE__*/_react.default.createElement("input", {
    name: "lng",
    className: _GeopointInput.default.inputField + ' ' + _GeopointInput.default.lng,
    type: "number",
    ...
    name: "alt",
    className: _GeopointInput.default.inputField + ' ' + _GeopointInput.default.alt,
    type: "number",
